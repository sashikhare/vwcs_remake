   ...
   <header id="header" id="home">
         ...
         <div class="container">
            <div class="row">
               ...
               <div class="col-lg-6 col-sm-6 col-4 header-top-right no-padding">
                  <Link to="/" onClick={this.backtotop}><span class="lnr lnr-phone-handset"></span> <span class="text">+91-9619123321/+91-9004935111</span></Link>
                  <Link to="/" onClick={this.backtotop}><span class="lnr lnr-envelope"></span> <span class="text">info@vwcs.in</span></Link>
               </div>
            </div>
         </div>
      </div>
      <div class="container main-menu">
         <div class="row align-items-center justify-content-between d-flex">
            <div id="logo">
               <Link to="/" onClick={this.backtotop}><img src="/img/logo.png" alt="" title="" /></Link>
            </div>
                  ...
                  <li class="menu-has-children">
                     ...
                     <ul class="submenu">
                        ...
                        <li>
                           ...
                           IWCF - Combined Surface & Subsea Stack: Level 2</Link>
                        </li>
                        <li>
                           <Link to="/courseThird" onClick={this.backtotop}>
                           IWCF - Surface Stack: Level 3 & 4</Link>
                        </li>
                        <li>
                           <Link to="/courseFour" onClick={this.backtotop}>
                           IWCF - Combined Surface & Subsea Stack: Level 3 & 4</Link>
                        </li>
                        <li>
                        ...
                        <li>
                           ...
                           IADC - Surface Stack: Fundamental & Supervisory Level</Link>
                        </li>
                        <li>
                           <Link to="/courseSeven" onClick={this.backtotop}>
                           IADC - Combined Surface & Subsea Stack: Fundamental & Supervisory Level</Link>
                        </li>
                        <li>
