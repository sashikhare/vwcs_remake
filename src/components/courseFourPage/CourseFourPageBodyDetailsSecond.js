...
import CourseFourPageBodyDetailsThird from './CourseFourPageBodyDetailsThird';
...
import '../../css/main.css';
class CourseFourPageBodyDetailsSecond extends React.Component {
  /*constructor(props) {
        super(props)
            ...
            <div class="menu-content pb-80 col-lg-11">
              <div class="title text-center">
                ...
                <div>
                  ...
                  <p>
                    <CourseFourPageBodyDetailsThird />
                  </p>
...
export default CourseFourPageBodyDetailsSecond;
